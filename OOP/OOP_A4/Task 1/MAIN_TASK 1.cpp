...
int main() {
    ...
    char content2[] = "/path/to/picture.jpg";
    char timestamp2[] = "2024-07-03";
    char caption2[] = "Beautiful scenery";

    char author3[] = "Mark Zuckerberg";
    ...
    // Array of Post pointers, storing instances of different post types
    Post* posts[] = {
    ...
    // Calling function to display data of all Posts
